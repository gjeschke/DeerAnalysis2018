function handles=fit_Tikhonov_noise_average(handles)
%
...
for rr=1:length(regpar_vector),
    ...
    for kn=1:trials,
        noise=nfac*handles.fit_rms_value*randn(size(dipevo));
        handles.A_dipevo=dipevo+noise;
